function [nii, nii_TR1, nii_TR2] = MSMEextract_PV6(pathname,scanNum, savenametype, MSME_Count,NSlices)
...
for j=1:1:numRecos
    ...
    if savenametype==1
        SaveName=strcat(pathsplit(1),'_Scan',scanNum,'_MSME_',recoType,'.nii');
    elseif savenametype==2
        counter=sprintf('%d',MSME_Count);
        SaveName=strcat(pathsplit(1),'_MSME_MSMEscan',counter,'_',recoType,'_', n,'.nii');
    end
