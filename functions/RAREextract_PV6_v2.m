function [nii, nii_TR1, nii_TR2] = RAREextract_PV6_v2(pathname,scanNum, savenametype, RARE_Count,n,SubjectName, NSlices)
...
for j=1:1:numRecos
    ...
    if savenametype==1
        ...
        SaveName=strcat(SubjectName,'_Scan',NewScanNum,'_RARE_',recoType,'.nii');
    elseif savenametype==2
        counter=sprintf('%d',RARE_Count);
        SaveName=strcat(SubjectName,'_RAREscan',counter,'_',recoType,'.nii');
    end
