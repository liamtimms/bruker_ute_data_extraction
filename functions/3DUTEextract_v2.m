function [nii] = 3DUTEextract_v2(pathname,scanNum, savenametype,UTE_Count)
...
for j=1:1:numRecos
    ...
    [Image, dim] = get_ImageMatrix(pathname,scanNum, recoNum, NumImages, Matrix_size, Slice_orientation)
