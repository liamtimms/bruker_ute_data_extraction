function [nii, slopelineSplit] = ThreeDUTEextract_PV6(pathname,scanNum, savenametype,UTE_Count)
...
%             SaveName=strcat(pathsplit(1),StudyName,'_Scan',scanNum,'_UTE3D_',recoType,'.nii');
        SaveName=strcat(pathsplit(1),'_Scan',scanNum,'_UTE3D_',recoType,'.nii');
        elseif savenametype==2
            counter=sprintf('%d',UTE_Count);
